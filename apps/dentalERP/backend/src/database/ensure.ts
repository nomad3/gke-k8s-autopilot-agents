...
export async function ensureCoreTables(pool: Pool): Promise<void> {
  ...
  try {
    ...
    await client.query(`
      ...
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS address jsonb NOT NULL DEFAULT '{}'::jsonb;
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS website varchar(255);
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS tax_id varchar(50);
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS settings jsonb NOT NULL DEFAULT '{}'::jsonb;
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS is_active boolean NOT NULL DEFAULT true;
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS created_at timestamptz NOT NULL DEFAULT now();
      ALTER TABLE practices ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();
    `);
