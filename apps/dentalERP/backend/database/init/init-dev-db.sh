...
echo "================================"
echo "Dev Database Initialization"
echo "================================"

# Extract connection details from DATABASE_URL
# For dev, using simpler password from docker-compose dev section
...
npm run db:generate || echo "Warning: db:generate failed (may be expected if no changes)"
...
npm run db:push || echo "Warning: db:push failed (may be expected if no changes)"
